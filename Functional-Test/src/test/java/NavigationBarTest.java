...
public class NavigationBarTest extends InsertClass{
    ...
    public void homeLinkOnProjectPageRedirectstoHomePage() {
        String project_id = insertDataForCurrentProject("Books for children","This is project for children who want to study.So please help by donating for their books","image/children.jpg","image/children_thumbnail.png","Donate for kids");
