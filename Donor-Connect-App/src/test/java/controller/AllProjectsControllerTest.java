...
public class AllProjectsControllerTest {
    ...
    public void setUp() {
        ...
        dummyProject1 = new Project(0, "name", "description", "image/path",true,"image/path","summary");
        dummyProject2 = new Project(0, "name2", "description2", "image/path2",true,"image/path","summary");
